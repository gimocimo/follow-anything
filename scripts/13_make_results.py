...
def build(dev, fin, pc, oc, em, tm, dev_gate, fin_gate, eval_games=("4","2"), train_games=("3","5","6","9")):
    ...
    return {
        "note": "Rung-3 result: yolo11l @ 1536 (4-class: player/goalkeeper/referee/ball) fine-tuned on "
                "GSR games {3,5,6,9}, tracked with tuned BoT-SORT, scored with the SAME sealed eval as "
                "Rung 1. GENERATED by scripts/13_make_results.py from the runtime manifests; every "
        ...
        "leak_free": {
            "detector_training": "yolo11l @ 1536 (4-class) fine-tuned on GSR games {3,5,6,9} (leave-one-game-out); "
